...
export default function ElectrolysisDiagram() {
  return (
    ...
    >
      ...
      {/* Background */}
      <rect width="800" height="648" fill="#0a0a0a" rx="10"/>
      ...
      <text x={CX + CW / 2} y="88" fill={NEON} fontSize="8"
      ...
      {/* ═══════════════════════════════════════════════
          ...
          ═══════════════════════════════════════════════ */}
      {/* Callout sits in the open space between plate labels and the flow line */}
      ...
      {/* cable body */}
      <line x1="20" y1="216" x2="98" y2="216" stroke={NEON} strokeWidth="2"/>
      {/* plug head */}
      <rect x="10" y="210" width="12" height="14"
        fill="none" stroke={NEON} strokeWidth="1.5" rx="2"/>
      <line x1="14" y1="208" x2="14" y2="211" stroke={NEON} strokeWidth="1.5"/>
      <line x1="18" y1="208" x2="18" y2="211" stroke={NEON} strokeWidth="1.5"/>
      {/* terminal dot on chamber wall */}
      <circle cx="100" cy="216" r="3.5" fill={NEON} opacity=".9"/>
      ...
      <text x="150" y="458" fill={NEON} fontSize="8"
      ...
      {/* ═══════════════════════════════════════════════
          LEGEND  (two rows)
          ═══════════════════════════════════════════════ */}
      <line x1="80" y1="594" x2="720" y2="594" stroke={DIM} strokeWidth=".5" opacity=".3"/>

      {/* row 1 */}
      <rect x="80"  y="601" width="9" height="9" fill="#001e0a" stroke={NEON} strokeWidth="1" rx="1"/>
      <text x="94"  y="609" fill={DIM} fontSize="7.5" fontFamily="'Courier New',monospace">CATHODE (C−)</text>

      <rect x="193" y="601" width="9" height="9" fill="#190000" stroke={ACD}  strokeWidth="1" rx="1"/>
      <text x="207" y="609" fill={DIM} fontSize="7.5" fontFamily="'Courier New',monospace">ANODE (A+)</text>

      <line x1="298" y1="605" x2="318" y2="605" stroke="#3a3a3a" strokeWidth="1" strokeDasharray="4 3"/>
      <text x="322" y="609" fill={DIM} fontSize="7.5" fontFamily="'Courier New',monospace">ION EXCHANGE MEMBRANE</text>

      <circle cx="480" cy="605" r="3" fill={H2C} opacity=".7"/>
      <text x="488" y="609" fill={DIM} fontSize="7.5" fontFamily="'Courier New',monospace">H₂ BUBBLE</text>

      {/* row 2 */}
      <line x1="80"  y1="628" x2="100" y2="628" stroke={BLUE} strokeWidth="1" strokeDasharray="4 3"/>
      ...
      <line x1="330" y1="624" x2="350" y2="624" stroke={NEON} strokeWidth="2"/>
